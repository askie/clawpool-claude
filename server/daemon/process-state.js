...
export async function inspectDaemonProcessState({
  ...
  const statusPath = resolveDaemonStatusPath({ ...env, GRIX_CLAUDE_DAEMON_DATA_DIR: dataDir });
  const lockPath = resolveDaemonLockPath({ ...env, GRIX_CLAUDE_DAEMON_DATA_DIR: dataDir });
