...
function normalizeRuntime(input) {
  ...
  return {
    ...
    worker_last_hook_event_id: normalizeString(input.worker_last_hook_event_id),
    worker_last_hook_event_name: normalizeString(input.worker_last_hook_event_name),
    worker_last_hook_event_detail: normalizeString(input.worker_last_hook_event_detail),
    worker_last_hook_event_at: normalizeOptionalTimestamp(input.worker_last_hook_event_at),
